...
const LegalNavbar = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 px-4 py-3 transition-all duration-500 ${isScrolled ? 'bg-black/50 backdrop-blur-md' : 'bg-transparent'}`}>
      <nav className="container mx-auto">
        <div className="flex justify-between items-center py-3 px-6 relative">
          {/* Logo */}
          ...
          <div className="flex items-center">
            <Link to="/chat">
              <Button 
                variant="outline" 
                className="bg-primary/10 text-white border-primary/30 hover:bg-primary/30 hover:border-primary/40 hover:scale-105 transition-all duration-300 text-sm rounded-full px-5"
              >
